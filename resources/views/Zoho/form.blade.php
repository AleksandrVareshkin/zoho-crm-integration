...
<form action="/form/submit" method="POST">
    ...
    <input type="text" id="deal_name" name="deal_name" required><br>

    <label for="deal_stage">Deal Stage:</label>
    <input type="text" id="deal_stage" name="deal_stage" required><br>

    <label for="account_name">Account Name:</label>
    <input type="text" id="account_name" name="account_name" required><br>

    <label for="account_website">Account Website:</label>
    <input type="url" id="account_website" name="account_website" required><br>
